...
% Affichage de l'erreur moyenne des 90%  plus faibles erreurs
pourcentage = 0.9;
Sort_Erreur = sort(erreur_max);
res = ['Moyenne des 90% + faibles Erreurs predictions max : ', num2str(mean(Sort_Erreur(1:round(length(erreur_max)*pourcentage))))];
disp(res);
Sort_Erreur = sort(erreur_conv);
res = ['Moyenne des 90% + faibles Erreurs predictions conv : ', num2str(mean(Sort_Erreur(1:round(length(erreur_conv)*pourcentage))))];
disp(res);
Sort_Erreur = sort(erreur_soustraction);
res = ['Moyenne des des 90% + faibles Erreurs predictions soustraction : ', num2str(mean(Sort_Erreur(1:round(length(erreur_soustraction)*pourcentage))))];
disp(res);
Sort_Erreur = sort(erreur_modes);
res = ['Moyenne des des 90% + faibles predictions modes : ', num2str(mean(Sort_Erreur(1:round(length(erreur_modes)*pourcentage))))];
disp(res);
