...
num_heatmap_dep = 0; % numéro de la première heatmap considéré
...
save('heatmaps','tests','predictions','joints','lien','nlig','ncol','num_heatmap_dep','nb_heatmaps','nb_angles','nb_joints');
